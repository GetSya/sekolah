...
case 'pendaftaran':
  case 'Pendaftaran':
ppdb = `Info Sekolah SMK

Nama Sekolah : SMK MUHAMMADIYAH 3 TANGSEL
Alamat : Jalan Dewi Sartika Gang Nangka No. 3, Cimanggis - Ciputat
Website : https://muhtiga.sch.id`
sendButMessage(from, ppdb, `© Smk Muhtiga`, [
          {
            buttonId: `${prefix}ppdb`,
            buttonText: {
              displayText: `Pendaftaran Murid Baru (PPDB)`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}jurusan`,
            buttonText: {
              displayText: `Jurusan / Program Keahlian`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}inforobot`,
            buttonText: {
              displayText: `Info Robot`,
            },
            type: 1,
          },
        ], {quoted: mek});
        break
case 'inforobot':
  reply(`Bahasa : JavaScript
Pembuat : Arasya  X - RPL
Nomer Owner : 6281319944917
Engine : NodeJs
Sekolah : Smk Muhtiga`)
break
case 'ppdb':
ppdb2 = `*[ SMK MUHAMMDIYAH 3 TANGSEL ]*
...
Instagram : @smkm3tangsel
Youtube : MUHTIGA OFFICIAL
===========================
linktr.ee/smkmuh3tangsel

Info Pendaftaran
Silahkan Hubungi Nomer Berikut

No : 021-7470-4878
WhatsApp : 0811-9242-333`
sendButMessage(from, ppdb2, `© Smk Muhtiga`, [
          {
            buttonId: `${prefix}kontak`,
            buttonText: {
              displayText: `kontak`,
            },
            type: 1,
        ...
        break
        case 'jurusan':
          jurus = `JURUSAN / PROGRAM KEAHLIAN
...
- Multimedia`
          sendButMessage(from, jurus, `© Smk Muhtiga`, [
          {
            buttonId: `${prefix}imagejurus`,
            buttonText: {
              displayText: `Foto Jurusan`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}imagelogo`,
            buttonText: {
              displayText: `Logo Muhammadiyah`,
            },
            type: 1,
          },
        ], {quoted: mek});
            break;
            case 'kontak':
        sendKontak(from, '628119242333', `Smk Muhtiga`, `© Tangsel`);
        break
        case 'imagejurus':
   truteh = await getBuffer(`https://telegra.ph/file/624bdb13089e16b466f29.jpg`)
					syaa.sendMessage(from, truteh, image)
   break
case 'imagelogo':
   logo = await getBuffer(`https://telegra.ph/file/94e1e400aeac192ae47b4.jpg`)
					syaa.sendMessage(from, logo, image)
   break
case 'tourl':
        if (
